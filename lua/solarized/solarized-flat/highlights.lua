...
function M.load_syntax(colors)
	...
	if g.solarized_visibility == "high" then
		...
		syntax["SpellBad"] = { fg = colors.violet, bg = colors.base2, guisp = colors.red, style = "underline" }
		syntax["SpellCap"] = { fg = colors.violet, bg = colors.base2, guisp = colors.red, style = "underline" }
		syntax["SpellLocal"] = { fg = colors.yellow, bg = colors.base2, guisp = colors.red, style = "underline" }
		syntax["SpellRare"] = { fg = colors.cyan, bg = colors.base2, guisp = colors.red, style = "underline" }
	...
	if g.solarized_statusline == "low" then
		syntax["StatusLine"] = { fg = colors.base02, bg = colors.base1, style = "bold" }
		syntax["StatusLineNC"] = { fg = colors.base02, bg = colors.base01 }
		syntax["TabLineSel"] = { fg = colors.base1, bg = colors.base02 }
		syntax["NormalMode"] = { fg = colors.base02, bg = colors.base1, style = "bold" }
	elseif g.solarized_statusline == "flat" then
		...
		syntax["NormalMode"] = { fg = colors.base02, bg = colors.base2 }
	else
		syntax["StatusLine"] = { fg = colors.base02, bg = colors.base2 }
		syntax["StatusLineNC"] = { fg = colors.base02, bg = colors.base1 }
		syntax["TabLineSel"] = { fg = colors.base2, bg = colors.base02 }
	...
	syntax["InsertMode"] = { fg = colors.base02, bg = colors.cyan, style = "bold" }
	syntax["ReplaceMode"] = { fg = colors.base02, bg = colors.orange, style = "bold" }
	syntax["VisualMode"] = { fg = colors.base02, bg = colors.magenta, style = "bold" }
	syntax["CommandMode"] = { fg = colors.base02, bg = colors.magenta, style = "bold" }
