...
function M.load_syntax(colors)
	...
	if g.solarized_visibility == "high" then
		...
		syntax["SpellBad"] = { fg = colors.violet, bg = colors.base3, guisp = colors.red, style = "underline" }
		syntax["SpellCap"] = { fg = colors.violet, bg = colors.base3, guisp = colors.red, style = "underline" }
		syntax["SpellLocal"] = { fg = colors.yellow, bg = colors.base3, guisp = colors.red, style = "underline" }
		syntax["SpellRare"] = { fg = colors.cyan, bg = colors.base3, guisp = colors.red, style = "underline" }
	...
	if g.solarized_statusline == "low" then
		syntax["StatusLine"] = { fg = colors.base01, bg = colors.base3 }
	...
	elseif g.solarized_statusline == "flat" then
		syntax["StatusLine"] = { fg = colors.base02, bg = colors.base3 }
	...
	syntax["WildMenu"] = { fg = colors.base3, bg = colors.base02 }
