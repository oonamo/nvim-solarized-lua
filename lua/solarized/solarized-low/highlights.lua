...
function M.load_syntax(colors)
	...
	if g.solarized_visibility == "high" then
		...
		syntax["SpellBad"] = { fg = colors.violet, bg = colors.base2, guisp = colors.red, style = "undercurl" }
		syntax["SpellCap"] = { fg = colors.violet, bg = colors.base2, guisp = colors.red, style = "undercurl" }
		syntax["SpellLocal"] = { fg = colors.yellow, bg = colors.base2, guisp = colors.red, style = "undercurl" }
		syntax["SpellRare"] = { fg = colors.cyan, bg = colors.base2, guisp = colors.red, style = "undercurl" }
	...
	if g.solarized_diffmode == "high" then
		syntax["DiffAdd"] = { fg = colors.green }
		syntax["DiffChange"] = { fg = colors.yellow }
		syntax["DiffDelete"] = { fg = colors.red }
		syntax["DiffText"] = { fg = colors.blue }
	...
	if g.solarized_statusline == "low" then
		syntax["StatusLine"] = { fg = colors.base1, bg = colors.base2 }
		syntax["StatusLineNC"] = { fg = colors.base1, bg = colors.base01 }
		syntax["TabLine"] = { fg = colors.base1, bg = colors.base01 }
		syntax["TabLineFill"] = { fg = colors.base1, bg = colors.base01 }
		syntax["TabLineSel"] = { fg = colors.base1, bg = colors.base2 }
		syntax["VertSplit"] = { fg = colors.base1 }
		syntax["WildMenu"] = { fg = colors.base00, bg = colors.base2 }
	elseif g.solarized_statusline == "flat" then
		syntax["StatusLine"] = { fg = colors.base3, bg = colors.base02 }
		syntax["StatusLineNC"] = { fg = colors.base3, bg = colors.base01 }
		...
		syntax["WildMenu"] = { fg = colors.base1, bg = colors.base3 }
	else
		syntax["StatusLine"] = { fg = colors.base01, bg = colors.base2 }
		syntax["StatusLineNC"] = { fg = colors.base0, bg = colors.base2 }
		syntax["TabLine"] = { fg = colors.base0, bg = colors.base2 }
		syntax["TabLineFill"] = { fg = colors.base0, bg = colors.base2 }
		syntax["TabLineSel"] = { fg = colors.base01, bg = colors.base2 }
		syntax["VertSplit"] = { fg = colors.base1 }
		syntax["WildMenu"] = { fg = colors.base0, bg = colors.base2 }
	end
	...
	syntax["CursorLine"] =
		{ fg = colors.none, guisp = colors.base0, style = "underline", ctermfg = colors.none, ctermbg = colors.none }
	...
	syntax["Visual"] = { fg = colors.base1, bg = colors.base3 }
	syntax["VisualNOS"] = { fg = colors.none, bg = colors.base2 }
	...
	syntax["NormalMode"] = { fg = colors.base01, bg = colors.base3 }
